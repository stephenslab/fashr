...
Note that the `selected_indices` argument allows us to specify the names of the eQTLs to be visualized:

```{r, fig.height=4.5, fig.width=3.5}
plot(fash_fit, plot_type = "heatmap", selected_indices = c("A1", "B1", "C1"))
```
